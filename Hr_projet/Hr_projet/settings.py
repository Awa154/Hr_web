"""
Django settings for Hr_projet project.
...
SECRET_KEY = 'django-insecure--0h8ajz_3@1*ml6--eei6kj0+x*7b5-*ovd!674tlzdduz5pz='
...
WSGI_APPLICATION = 'Hr_projet.wsgi.application'
